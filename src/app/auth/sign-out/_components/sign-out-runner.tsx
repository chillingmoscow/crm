...
/**
 * Клиентская часть /auth/sign-out. Про режим просмотра за другого
 * пользователя здесь намеренно ничего нет: страница-обёртка не пускает
 * сюда, пока он активен (см. ../page.tsx). Выход всегда завершает СВОЮ
 * сессию — других тут не бывает.
 *
