...
begin
  ...
  values
    -- ИНВ-0002: молочка. Акт «Новый», ещё не считали → факт NULL, расхождения
    -- нет (триггер автомаркера не флажит несосчитанные строки, миграция 211).
    (v_account, '55555555-5555-0000-0000-000000000002'::uuid, 'd2-1', v_p_milk, 'Молоко 3.2%',     null, 56.0, null),
    (v_account, '55555555-5555-0000-0000-000000000002'::uuid, 'd2-2', v_p_chs,  'Сыр Моцарелла',   null, 12.5, null),
    -- ИНВ-0003: овощи (в работе — частично сосчитано)
    ...
    -- ИНВ-0004: мясо (готов к проверке — сосчитано)
