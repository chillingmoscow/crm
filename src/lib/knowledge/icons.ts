...
export const KB_ICONS: KbIcon[] = [
  ...
  // ─── Кухня и бар ───────────────────────────────────────
  { name: "utensils",         icon: Utensils,         group: "Кухня и бар", label: "Сервировка" },
  { name: "utensils-crossed", icon: UtensilsCrossed,  group: "Кухня и бар", label: "Приборы" },
  { name: "coffee",           icon: Coffee,           group: "Кухня и бар", label: "Кофе" },
  { name: "wine",             icon: Wine,             group: "Кухня и бар", label: "Вино" },
  { name: "beer",             icon: Beer,             group: "Кухня и бар", label: "Пиво" },
  { name: "martini",          icon: Martini,          group: "Кухня и бар", label: "Коктейль" },
  { name: "cup-soda",         icon: CupSoda,          group: "Кухня и бар", label: "Напиток" },
  { name: "pizza",            icon: Pizza,            group: "Кухня и бар", label: "Пицца" },
  { name: "soup",             icon: Soup,             group: "Кухня и бар", label: "Суп" },
  { name: "salad",            icon: Salad,            group: "Кухня и бар", label: "Салат" },
  { name: "sandwich",         icon: Sandwich,         group: "Кухня и бар", label: "Сэндвич" },
  { name: "beef",             icon: Beef,             group: "Кухня и бар", label: "Мясо" },
  { name: "fish",             icon: Fish,             group: "Кухня и бар", label: "Рыба" },
  { name: "egg",              icon: Egg,              group: "Кухня и бар", label: "Яйцо" },
  { name: "croissant",        icon: Croissant,        group: "Кухня и бар", label: "Круассан" },
  { name: "apple",            icon: Apple,            group: "Кухня и бар", label: "Яблоко" },
  { name: "carrot",           icon: Carrot,           group: "Кухня и бар", label: "Морковь" },
  { name: "cake",             icon: Cake,             group: "Кухня и бар", label: "Торт" },
  { name: "ice-cream",        icon: IceCream,         group: "Кухня и бар", label: "Десерт" },
  { name: "cookie",           icon: Cookie,           group: "Кухня и бар", label: "Печенье" },
